  ...
  return (
    <main className="bg-[#f5f5f5]">
                ...
                <div className="bg-gradient-to-r from-primary/5 to-[#D4AF37]/5 border border-primary/20 rounded-lg p-4 mb-6">
                  ...
                  >
                    <input
                      ...
                      className="flex-1 min-w-[140px] px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-primary focus:shadow-[0_0_0_3px_rgba(153,101,21,0.15)] transition-all"
                      required
                    />
                    <input
                      type="tel"
                    ...
                    <button
                      type="submit"
                      className="px-6 py-3 bg-gradient-to-r from-[#996515] to-[#D4AF37] text-white font-semibold rounded-lg hover:shadow-lg transition-all btn-shine whitespace-nowrap"
                    >
                      Gửi
                    </button>
                  </form>
          ...
          <div className="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            >
              <button
                ...
                className={`px-8 py-4 font-bold text-lg uppercase tracking-wide transition-colors ${
                  activeTab === "detail"
                    ? "text-primary"
      ...
      {relatedProducts.length > 0 && (
        <section className="py-16 bg-gradient-to-br from-amber-50 via-white to-yellow-50 relative overflow-hidden">
          {/* Decorative background elements */}
          <div className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-br from-[#996515]/5 to-transparent rounded-full -translate-x-1/2 -translate-y-1/2" />
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-[#D4AF37]/5 to-transparent rounded-full translate-x-1/3 translate-y-1/3" />

          <div className="container mx-auto px-4 relative z-10">
            {/* Title with decorative lines */}
            <div className="flex items-center justify-center gap-4 mb-10">
              <div className="h-[2px] w-16 lg:w-24 bg-gradient-to-r from-transparent to-[#996515]" />
              <h2 className="text-2xl lg:text-3xl font-bold uppercase bg-gradient-to-r from-[#996515] to-[#D4AF37] bg-clip-text text-transparent whitespace-nowrap">
                Sản phẩm tương tự
              </h2>
              <div className="h-[2px] w-16 lg:w-24 bg-gradient-to-l from-transparent to-[#D4AF37]" />
            </div>
            ...
            <div className="relative group/carousel">
              ...
              <button
                ...
                className="related-prev absolute -left-2 lg:-left-5 top-1/2 -translate-y-1/2 z-10 w-11 h-11 bg-gradient-to-r from-[#996515] to-[#D4AF37] hover:from-[#7a5011] hover:to-[#b8982f] text-white rounded-full shadow-lg flex items-center justify-center transition-all cursor-pointer opacity-0 group-hover/carousel:opacity-100 hover:scale-110"
              >
                <ChevronLeft size={24} />
              </button>
              <button
                ...
                className="related-next absolute -right-2 lg:-right-5 top-1/2 -translate-y-1/2 z-10 w-11 h-11 bg-gradient-to-r from-[#996515] to-[#D4AF37] hover:from-[#7a5011] hover:to-[#b8982f] text-white rounded-full shadow-lg flex items-center justify-center transition-all cursor-pointer opacity-0 group-hover/carousel:opacity-100 hover:scale-110"
              >
